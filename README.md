...
- **悬浮窗模式**（点右上角"⧉ 悬浮窗"收起，置顶、不占任务栏）
  - 三种样式可选（完整面板右上角下拉框）：**桌宠**（200×220，精灵动画随状态切换：生成中跑步、待机站立，头顶气泡显示实时速度，🔄 换宠物）/ **迷你仪表盘**（116×116）/ **速度胶囊**（224×78）
...
- 今日 Token 总量 = `input + output + reasoning + cache`，按事件完成时间归属"今日"，跨天自动重置。
